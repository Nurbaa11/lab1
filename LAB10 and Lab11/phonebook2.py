...
while True:
    ...
    2. Type "q" or "Q" in order to make specific QUERY in the table.
    3. Type "d" or "D" in order to DELETE data from the table.
    4. Type "s" or "S" in order to see the values in the table.
    5. Type "f" or "F" in order to close the program.
    6. Type "8" in order to see all informations about person.
    7. Type "9" in order to add many users by one running code.
    8. Type "p" in order to query with pagination.
    """)
